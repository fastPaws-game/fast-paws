    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#fff" viewBox="0 0 24 24">
      <g>
        <g fill="none" fillRule="evenodd" stroke="none" strokeWidth="1">
          <g fillRule="nonzero" transform="translate(-96 -240)">
            <g transform="translate(96 240)">
              ...
              <path
                fill="#fff"
                d="M10.756 6.17l7.07 7.071-7.173 7.174a2 2 0 01-1.238.578L9.239 21H4.006c-.52 0-.949-.394-1.004-.9l-.006-.11v-5.233a2 2 0 01.467-1.284l.12-.13 7.173-7.174zm3.14-3.14a2 2 0 012.701-.117l.127.117 4.243 4.243a2 2 0 01.117 2.7l-.117.128-1.726 1.726-7.07-7.071 1.725-1.726z"></path>
            </g>
          </g>
        </g>
      </g>
